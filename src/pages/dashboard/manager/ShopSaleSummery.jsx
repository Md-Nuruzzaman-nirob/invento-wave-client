...
const ShopSaleSummery = () => {
  ...
  const totalInvest = saleData.reduce((accumulator, currentValue) => {
      ...
      <div className="grid grid-cols-1  sm:grid-cols-3 gap-8 xl:gap-16 ">
        <div className="flex items-center justify-evenly bg-white rounded-md py-5">
          ...
          <div className="lg:space-y-3">
            ...
            <p className="text-sm xl:text-lg font-semibold">Sale</p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-evenly bg-white rounded-md py-5">
          ...
          <div className="lg:space-y-3">
            ...
            <p className="text-sm xl:text-lg font-semibold">Invest</p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-evenly bg-white rounded-md py-5">
          ...
          <div className="lg:space-y-3">
            ...
            <p className="text-sm xl:text-lg font-semibold">Profit</p>
          </div>
        </div>
      </div>
      <div className="my-16">
